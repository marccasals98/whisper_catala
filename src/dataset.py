...
def get_common_voice():
    ...
    common_voice["train"] = load_dataset(DATASET['name'], split="train+validation", use_auth_token=True)
    common_voice["test"] = load_dataset(DATASET['name'], split="test", use_auth_token=True)
